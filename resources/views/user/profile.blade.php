        ...
        <div class="row">
            <div class="col-md-3">
                <div class="user-info-left profile_pic_container">
                    ...
                    <h2>{{\UserInterface::editable('first_name',route('save_profile'), $first_name,'text', 'Enter Your First Name');}} {{\UserInterface::editable('last_name',route('save_profile'), $last_name,'text', 'Enter Your Last Name');}} <i class="fa fa-circle green-font online-icon"></i><sup class="sr-only">online</sup></h2>
                    <div class="contact">
