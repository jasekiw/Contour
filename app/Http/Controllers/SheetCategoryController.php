...
class SheetCategoryController extends Controller
{
    ...
    public function show($id, $letter = null)
    {
        ...
        {
            array_push($breadcrumbs, ['title' => $tag->get_name(), 'link' => route('sheetcategories_show', [$tag->get_id()])]);
        }
        array_push($breadcrumbs, ['title' => $parent->get_name(), 'link' => route('sheetcategories_show', [$parent->get_id()])]);
