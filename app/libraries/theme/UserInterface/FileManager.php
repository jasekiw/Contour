    ...
    public static function render()
    {
        ...
        <div class="file-manager">
            <ul class="list-inline file-main-menu">
                <li>
                    <a href="#">
                        <span class="fa-stack fa-lg"><i class="fa fa-file-o fa-stack-2x"></i><i
                                class="fa fa-plus-square-o fa-stack-1x"></i></span> New File
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="fa-stack fa-lg"><i class="fa fa-folder-o fa-stack-2x"></i><i
                                class="fa fa-plus-square-o fa-stack-1x"></i></span> New Folder
                    </a>
                </li>
                ...
                <li>
                    <a href="#" class="inactive">
                        <span class="fa-stack fa-lg"><i class="fa fa-file-o fa-stack-2x"></i><i
                                class="fa fa-arrow-right fa-stack-1x"></i></span> Move File
                    </a>
                </li>
                ...
                <li>
                    <a href="#" class="inactive">
                        <span class="fa-stack fa-lg"><i class="fa fa-exchange fa-stack-1x"></i><i
                                class="fa fa-file-o fa-stack-2x"></i></span> Rename
                    </a>
                </li>
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4">
                    ...
                    <div class="well tree-wrapper">
                        <div id="tree-file-manager" class="jstree jstree-1 jstree-default jstree-loading" role="tree"
                             tabindex="0" aria-activedescendant="j1_loading" aria-busy="true">
                            <ul class="jstree-container-ul jstree-children" role="group">
                                <li id="j1_loading" class="jstree-initial-node jstree-loading jstree-leaf jstree-last"
                                    role="tree-item"><i class="jstree-icon jstree-ocl"></i><a class="jstree-anchor"
                                                                                              href="#"><i
                                            class="jstree-icon jstree-themeicon-hidden"></i>Loading ...</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-10 col-md-8">
                    ...
                    <div class="table-responsive">
                        <div id="datatable-file-manager_wrapper" class="dataTables_wrapper no-footer">
                            <div class="DTTT_container"></div>
                            <div class="clear"></div>
                        </div>
                        <table id="datatable-file-manager"
                               class="table table-sorting table-dark-header datatable dataTable no-footer DTTT_selectable"
                               style="width: 1249px;">
                            <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="datatable-file-manager" rowspan="1"
                                    colspan="1" aria-label="Name: activate to sort column descending"
                                    aria-sort="ascending" style="width: 181px;">Name
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-file-manager" rowspan="1"
                                    colspan="1" aria-label="Size: activate to sort column ascending"
                                    style="width: 155px;">Size
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-file-manager" rowspan="1"
                                    colspan="1" aria-label="Last Modified: activate to sort column ascending"
                                    style="width: 322px;">Last Modified
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-file-manager" rowspan="1"
                                    colspan="1" aria-label="Type: activate to sort column ascending"
                                    style="width: 169px;">Type
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-file-manager" rowspan="1"
                                    colspan="1" aria-label="Permissions: activate to sort column ascending"
                                    style="width: 307px;">Permissions
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"><i class="fa fa-folder"></i> Fast E-Commerce</td>
                                <td>0 KB</td>
                                <td>18/01/2015</td>
                                <td>Directory</td>
                                <td>755</td>
                            ...
                            <tr role="row" class="even">
                                <td class="sorting_1"><i class="fa fa-folder"></i> Project 123GO</td>
                                <td>53 KB</td>
                                <td>17/12/2014</td>
                                <td>Directory</td>
                                <td>755</td>
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"><i class="fa fa-folder"></i> SEO</td>
                                <td>0 KB</td>
                                <td>05/01/2015</td>
                                <td>Directory</td>
                                <td>755</td>
                            ...
                            <tr role="row" class="even">
                                <td class="sorting_1"><i class="fa fa-folder"></i> Spot Media</td>
                                <td>0 KB</td>
                                <td>22/12/2014</td>
                                <td>Directory</td>
                                <td>755</td>
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1"><i class="fa fa-folder"></i> Web Redesign</td>
                                <td>153 KB</td>
                                <td>23/02/2015</td>
                                <td>Directory</td>
                                <td>755</td>
