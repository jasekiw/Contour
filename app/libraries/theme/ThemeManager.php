...
class ThemeManager
{
    ...
    private $specific_enqueue_scripts = array();
    private $specific_enqueue_styles = array();
    private $footertasks = array();
    private $menu = null;
    ...
    public function enqueueScript( $name,  $src, $group = null  )
    {
        ...
        if(isset($group))
        {
            ...
            {
                $this->specific_enqueue_scripts[$group] = array();
            }
    ...
    public function enqueueStyle( $name,  $src, $group = null  )
    {
        ...
        if(!isset($group))
        {
            ...
            {
                $this->specific_enqueue_styles[$group] = array();
            }
