...
class ImportRule
{
     ...
     * @param string $axis      The direction of the table. is the table horizontal or vertical?
     *                          ImportRule::ONE_DIMENSIONS_TAG_AXIS_Y || ImportRule::ONE_DIMENSIONS_TAG_AXIS_X
     *
     * @return ImportRule
     */
